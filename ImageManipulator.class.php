...
* $Id: ImageManipulator.class.php,v 1.17 2013/08/20 23:44:15 horst Exp $
*********************************************************************************************/
...
//			$this->modified = true;  // this is from ImageResizer, don't know if we can use this here
		...
		*/
		...
		suitable for
		digital imaging. The principle of unsharp masking is to create a blurred
		copy of the image
		...
		////
		/////////////////////////////////////////////////////////////////*/
		function unsharpMask($amount=100, $radius=0.5, $threshold=3) {
			if($this->bypassOperations) {
				return $this;
			}
			if(false === ($im = $this->imLoad())) {
			...
			imagecopy ($imgCanvas, $im, 0, 0, 0, 0, $w, $h);
			imagecopy ($imgCanvas2, $im, 0, 0, 0, 0, $w, $h);
